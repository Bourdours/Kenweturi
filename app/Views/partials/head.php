...
<head>
    <script>
        ...
        if (localStorage.getItem('carCursor') !== 'on') document.documentElement.classList.add('car-off');
        if (localStorage.getItem('rainbowRoad') === 'on') document.documentElement.classList.add('rainbow-road');
    </script>
    <meta charset="UTF-8">
