...
<footer class="bg-paper border-t border-action/10 px-6 md:px-12 py-10">
  <div class="max-w-6xl mx-auto flex flex-col md:flex-row gap-10 justify-between">
    ...
    <div class="md:max-w-xs">
      <a href="<?= site_url('/') ?>" class="flex items-center gap-2 mb-3">
        <div class="w-6 h-6 rounded-full bg-action flex items-center justify-center shrink-0">
          <i class="fa-solid fa-car-side text-ink text-[10px]"></i>
        </div>
        <span class="font-display text-ink font-bold text-sm">Kenweturi</span>
      </a>
    ...
    <div class="flex flex-col md:flex-row gap-8 md:gap-16">
      ...
      <div>
        <p class="text-ink/30 text-[10px] uppercase tracking-widest font-medium mb-3">Service</p>
      ...
      <div>
        <p class="text-ink/30 text-[10px] uppercase tracking-widest font-medium mb-3">Entreprise</p>
        <ul class="flex flex-col gap-2">
      ...
      <div>
        <p class="text-ink/30 text-[10px] uppercase tracking-widest font-medium mb-3">Légal</p>
        <ul class="flex flex-col gap-2">
