...
/** @var string $driverFirstname */
/** @var string $driverLastname */
...
<head>
    ...
    <title>Votre réservation a été acceptée</title>
</head>
                    ...
                    <tr>
                        <td style="background-color:#16222e;padding:40px;">
                            ...
                            <p style="margin:0 0 28px;font-size:15px;color:#93b8d8;line-height:1.6;">
                                Votre réservation a été <strong style="color:#ffffff;">acceptée</strong> par <?= esc($driverFirstname) ?> <?= esc($driverLastname) ?>.
                            </p>
