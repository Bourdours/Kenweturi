                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
                    ...
                    <tr>
                        <td style="background-color:#16222e;padding:40px;">
                            ...
                            <p style="margin:0 0 28px;font-size:15px;color:#93b8d8;line-height:1.6;">
                                Suite à un signalement et après examen par notre équipe de modération, votre compte sur la plateforme <strong style="color:#ffffff;">Kenweturi</strong> a été suspendu.
                            </p>

                            <p style="margin:0;font-size:15px;color:#93b8d8;line-height:1.6;">
                                Vous ne pouvez plus accéder à vos services. Si vous pensez qu'il s'agit d'une erreur, contactez notre support.
                            </p>
