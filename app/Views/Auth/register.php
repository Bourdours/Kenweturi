...
<div class="max-w-5xl mx-auto py-10 px-6 md:px-8">

  <p class="text-ink/40 text-sm mb-1">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="bg-surface rounded-2xl p-5 border border-action/10">
          <p class="text-xs font-medium text-ink/50 mb-3 flex items-center gap-1.5">
            <i class="fa-regular fa-id-card"></i>Identité
          </p>

          <div class="grid grid-cols-2 gap-3 mb-3">
            <div>
              <label for="firstName" class="text-ink/50 text-[10px] mb-1.5 flex items-center gap-1">
            ...
            <div>
              <label for="lastName" class="text-ink/50 text-[10px] mb-1.5 flex items-center gap-1">
          ...
          <div class="grid grid-cols-2 gap-3">
            <div>
              <label for="gender" class="text-ink/50 text-[10px] mb-1.5 flex items-center gap-1">
              ...
              <div class="relative">
                ...
                <i class="fa-solid fa-chevron-down absolute right-3 top-1/2 -translate-y-1/2 text-ink/30 text-[10px] pointer-events-none"></i>
              </div>
            </div>
            <div>
              <label for="birthDate" class="text-ink/50 text-[10px] mb-1.5 flex items-center gap-1">
        ...
        <div class="bg-surface rounded-2xl p-5 border border-action/10">
          ...
          <div class="grid gap-3" style="grid-template-columns:1fr 120px;">
            <div>
              <label for="cityName" class="text-ink/50 text-[10px] mb-1.5 flex items-center gap-1">
            ...
            <div>
              <label for="postalCode" class="text-ink/50 text-[10px] mb-1.5 flex items-center gap-1">
      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="bg-surface rounded-2xl p-5 border border-action/10">
          ...
          <div class="mb-3">
            <label for="password" class="text-ink/50 text-[10px] mb-1.5 flex items-center gap-1">
          ...
          <div>
            <label for="passConfirm" class="text-ink/50 text-[10px] mb-1.5 flex items-center gap-1">
        ...
        <div class="bg-surface rounded-2xl p-5 border border-action/10">
          ...
          <label class="flex items-start gap-2 cursor-pointer mb-4">
            ...
            <span class="text-[11px] text-ink/40 leading-relaxed">
          ...
          <button type="submit"
            class="w-full bg-action hover:bg-action-dark text-ink font-semibold font-display rounded-lg py-3 text-sm mb-3 transition-colors cursor-pointer">
